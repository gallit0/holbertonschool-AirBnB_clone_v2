...
association_table = Table(
    "place_amenity",
    Base.metadata,
    Column("place_id", String(60),ForeignKey("places.id"), primary_key=True, onupdate='CASCADE', ondelete='CASCADE', nullable=False),
    Column("amenity_id", String(60), ForeignKey("amenities.id"), primary_key=True, onupdate='CASCADE', ondelete='CASCADE', nullable=False))
